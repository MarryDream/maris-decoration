...
public class ComponentWallBlock extends DirectionShapeHalfConnectBlock {
    // 底部直线
    protected static final BlockShape NORTH_STRAIGHT_BOTTOM = new BlockShape( 0.0, 0.0, 0.0, 16.0, 16.0, 2.0, -1 );
    protected static final BlockShape SOUTH_STRAIGHT_BOTTOM = new BlockShape( 0.0, 0.0, 14.0, 16.0, 16.0, 16.0, -1 );
    protected static final BlockShape WEST_STRAIGHT_BOTTOM = new BlockShape( 0.0, 0.0, 0.0, 2.0, 16.0, 16.0, -1 );
    protected static final BlockShape EAST_STRAIGHT_BOTTOM = new BlockShape( 14.0, 0.0, 0.0, 16.0, 16.0, 16.0, -1 );
    ...
    // 底部外角柱
    protected static final BlockShape NORTH_WEST_OUTER_BOTTOM = new BlockShape( 0.0, 0.0, 0.0, 2.0, 16.0, 2.0, -1 );
    protected static final BlockShape SOUTH_WEST_OUTER_BOTTOM = new BlockShape( 0.0, 0.0, 14.0, 2.0, 16.0, 16.0, -1 );
    protected static final BlockShape NORTH_EAST_OUTER_BOTTOM = new BlockShape( 14.0, 0.0, 0.0, 16.0, 16.0, 2.0, -1 );
    protected static final BlockShape SOUTH_EAST_OUTER_BOTTOM = new BlockShape( 14.0, 0.0, 14.0, 16.0, 16.0, 16.0, -1 );
