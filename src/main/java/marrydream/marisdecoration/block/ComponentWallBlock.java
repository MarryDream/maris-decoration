...
public class ComponentWallBlock extends DirectionShapeHalfConnectBlock {
    // 底部外角柱（外角柱碰撞体积上下都是一样的）
    protected static final BlockShape NORTH_WEST_OUTER = new BlockShape( 0.0, 0.0, 0.0, 2.0, 16.0, 2.0, -1 );
    protected static final BlockShape SOUTH_WEST_OUTER = new BlockShape( 0.0, 0.0, 14.0, 2.0, 16.0, 16.0, -1 );
    protected static final BlockShape NORTH_EAST_OUTER = new BlockShape( 14.0, 0.0, 0.0, 16.0, 16.0, 2.0, -1 );
    protected static final BlockShape SOUTH_EAST_OUTER = new BlockShape( 14.0, 0.0, 14.0, 16.0, 16.0, 16.0, -1 );
